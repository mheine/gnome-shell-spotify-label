...
function buildPrefsWidget() {
  ...
  extensionPlaceComboBox.set_active(
    options.indexOf(settings.get_string('extension-place'))
  );
  ...
  /* ads-muter */
  let adsMuterLabel = new Gtk.Label({
    label: 'Mute Advertisements:',
    halign: Gtk.Align.START,
    visible: true,
  });

  let adsMuterSwitch = new Gtk.Switch({
    valign: Gtk.Align.END,
    halign: Gtk.Align.END,
    visible: true,
  });
  ...
  index++;
  prefsWidget.attach(adsMuterLabel, 0, index, 1, 1);
  prefsWidget.attach(adsMuterSwitch, 1, index, 1, 1);
